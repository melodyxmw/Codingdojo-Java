...
public class Ninja {
	...
	public Ninja(String name, int health, String saying) {
		...
		//int newCount = this.getNumberOfNinjas() + 1;
		//this.setNumberOfNinjas(newCount);
	}
	
	public void strick(Ninja ninja) {
		System.out.println(this.getName() + " punches " + ninja.getName());
		int updatedHealth =ninja.getHealth() -30;
		
		ninja.setHealth(updatedHealth);
		
		System.out.println(ninja.getName() + " only has " + ninja.getHealth() + " left ! ");
